...
class AOTDispatchSubclassWrapper(CompilerWrapper):
    ...
    def post_compile(
        ...
        *,
        ...
        #   region (saved for backward), disjoint from output_info.  These may
        #   be FakeScriptObject when a constant opaque is saved for backward
        #   (Inductor stores FakeScriptObject in torchbind_constants at
        #   graph.py:1609-1612).
